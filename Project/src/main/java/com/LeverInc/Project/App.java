...
public class App extends Application
{
	public static void main(String[] args) {
		...
		try {
			...
			addFavorite(conn, "google.com");
			addFavorite(conn, "amazon.com");
			addFavorite(conn, "facebook.com");
			addFavorite(conn, "twitch.tv");
			addFavorite(conn, "cnn.com");

			String selectStatement = "SELECT Fav_ID, URL FROM Favorites";
			...
			while (result.next()) {
				System.out.printf("%-4d %-10s\n", result.getInt("Fav_ID"), result.getString("URL"));
			}
	...
	public static void addFavorite(Connection conn, String favURL) {
		try {
			Statement stmt = conn.createStatement();
			String insertFavorite = String.format(
					"INSERT into Favorites(URL)" + " values ('%s')", favURL);
